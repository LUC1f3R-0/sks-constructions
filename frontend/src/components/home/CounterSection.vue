  ...
  <section class="counter-section">
    <div class="counter-background">
      <img
        ...
        alt="Construction Counter Background" />
    ...
    <div class="container-fluid">
      ...
      <div class="row justify-content-center g-4 d-none d-md-flex">
        <div v-for="(counter, index) in counters" :key="index" class="col-xl-3 col-lg-4 col-md-6" data-aos="fade-up"
      ...
      <div class="mobile-counters d-md-none">
        <div v-for="(counter, index) in counters" :key="index" class="mobile-counter-item" data-aos="fade-up"
          :data-aos-delay="index * 200">
